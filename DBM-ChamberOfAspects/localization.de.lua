...
L:SetMiscLocalization({
	...
	twilightcutter			= "Hütet euch vor dem Schatten!", --"Die kreisenden Sphären pulsieren vor dunkler Energie!" -- Can't use this since on  it triggers twice, 5s prior and on cutter.
