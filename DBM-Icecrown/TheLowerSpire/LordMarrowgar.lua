...
function mod:SPELL_AURA_APPLIED(args)
	if args.spellId == 69076 then						-- Bone Storm (Whirlwind)
		...
		if self:IsHeroic() then
			timerWhirlwind:Show(30)			-- As of 16/11/2022,  fixed this timer - 30s
		else
